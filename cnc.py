...
original_list = ['Home','Tool Wear Detection', 'Tool Wear Prediction', 'Tool Performance', 'Tool Analysis','Outlier Detection','Data Analysis','Tips','How To Use']
...
if result == 'How To Use':
    st.subheader('How To Use')
    st.markdown('''
    + ##### Step 1 : Take raw data from inbuilt sensors that available in machine.
    + ##### Step 2 :  Convert Raw data into csv or excel format.
    + ##### Step 3 : upload that csv or excel file in file uploader section.If you can't view these option just click on arrow available on left top corner.
    + ##### Step 4 : After uploading files choose one option you want.          
